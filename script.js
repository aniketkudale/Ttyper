...
var Typer={
	...
	function ccolor()  // New Feature By Aniket Kudale
	{
		
   		 var sheet=document.getElementById("ccolor").value;
   		 var newc= document.getElementById("console");
   		 var niche=document.getElementById("cTable");

  		 if(sheet=="indigo") {
   			document.body.style.background="indigo";
   			newc.style.backgroundColor-"indigo";
   			document.body.style.color="yellow";
   			niche.style.backgroundColor="indigo";
   		 }
  		 else if(sheet=="gray") {
   			document.body.style.backgroundColor="gray";
   			newc.style.backgroundColor-"gray";
   			document.body.style.color="white";
   			niche.style.backgroundColor="gray";
   		 }
   		else if(sheet=="white") {
   			document.body.style.backgroundColor="white";
   			newc.style.backgroundColor-"white";
   			document.body.style.color="black";
   			niche.style.backgroundColor="white";
   		 }
        else if(sheet=="dark blue") {
   			document.body.style.backgroundColor="darkblue";
   			newc.style.backgroundColor-"darkblue";
   			document.body.style.color="yellow";
   			niche.style.backgroundColor="darkblue";
  		 }
   		else {
   			document.body.style.backgroundColor="black";
   			newc.style.backgroundColor-"black";
   			document.body.style.color="lime";
   			niche.style.backgroundColor="black";
   		}
}
